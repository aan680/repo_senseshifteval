...
Rscript scripts/make_wordlevel_gold_from_synsetlevel_gold.R --folder=$folder_hw --file_input_gold_synset=$gold_hwplus_synset --file_input_wordpair="evaluationset_wordpair.csv"
Rscript scripts/make_wordlevel_gold_from_synsetlevel_gold.R --folder=$folder_wsct --file_input_gold_synset=$gold_wsctplus_synset --file_input_wordpair="evaluationset_wordpair.csv"
